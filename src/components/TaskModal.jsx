          ...
          <div className="pt-0 flex flex-col gap-0.5">
            ...
            <div className="grid grid-cols-[110px_1fr] items-center gap-2.5 py-2.5 border-b border-[rgba(17,111,152,0.10)]">
              ...
              <div className="bg-prime-azul-25 rounded-form h-[30px] flex items-center px-2.5 cursor-pointer relative">
                <span className="flex-1 text-[12px] font-normal text-prime-azul">Selecione uma opção</span>
            ...
            <div className="grid grid-cols-[110px_1fr] items-center gap-2.5 py-2.5 border-b border-[rgba(17,111,152,0.10)]">
              ...
              <div className="bg-prime-azul-25 rounded-form h-[30px] flex items-center px-2.5 cursor-pointer relative">
                <span className="flex-1 text-[12px] font-normal text-prime-azul">DD/MM/AAAA</span>
            ...
            <div className="grid grid-cols-[110px_1fr] items-center gap-2.5 py-2.5 border-b border-[rgba(17,111,152,0.10)]">
              ...
              <div className="bg-prime-azul-25 rounded-form min-h-[30px] h-auto flex items-center flex-wrap gap-1 py-1 px-2 cursor-pointer relative">
                <div className="inline-flex items-center gap-[5px] bg-prime-azul-25 rounded-form py-0.5 pr-1.5 pl-1 text-[11px] text-prime-azul">
                  <div className="w-4 h-4 rounded-full bg-prime-azul text-white grid place-items-center text-[8px] font-bold">U</div>
                  Usuário
